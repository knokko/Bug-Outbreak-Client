Game.menus.profile.models.overview = new Gui.Menu('rgb(0,150,120)', function(){
	...
	this.addComponent(Game.menus.profile.models.list, 0.1, 0.3, 0.5, 0.7);
	this.addComponent(Game.menus.profile.models.selected, 0.6, 0.4, 0.95, 0.7);
	...
	this.setSelected = function(model){
		Game.menus.profile.models.selected.setSelected(model);
